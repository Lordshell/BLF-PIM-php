...
use AKKBLFPIM23Lib\Http\HttpCallBack;
...
class HttpCallBackCatcher extends HttpCallBack
{
    /**
     * Http request
     * @var AKKBLFPIM23Lib\Http\HttpRequest
     */
    private $request;

    /**
     * Http Response
     * @var AKKBLFPIM23Lib\Http\HttpResponse
     */
    private $response;
     ...
     * @return AKKBLFPIM23Lib\Http\HttpRequest
     */
     ...
     * @return AKKBLFPIM23Lib\Http\HttpResponse
     */
