...
{
    /**
     * @var FamilyController The reference to *Singleton* instance of this class
     */
    private static $instance;

    /**
     * Returns the *Singleton* instance of this class.
     * @return FamilyController The *Singleton* instance.
     */
    ...
    public function getFamily()
    {
        ...
        $_queryBuilder = $_queryBuilder.'/rest/v1/families/camcorders';
    ...
    public function getFamilies()
    {
        ...
        //prepare query string for API call
        $_queryBuilder = $_queryBuilder.'/rest/v1/families';
