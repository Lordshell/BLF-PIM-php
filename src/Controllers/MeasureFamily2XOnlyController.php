 ...
 */
class MeasureFamily2XOnlyController extends BaseController
{
    /**
     * @var MeasureFamily2XOnlyController The reference to *Singleton* instance of this class
     */
    private static $instance;

    /**
     * Returns the *Singleton* instance of this class.
     * @return MeasureFamily2XOnlyController The *Singleton* instance.
     */
    ...
    public function getMeasureFamily2XOnly()
    {
        ...
        $_queryBuilder = $_queryBuilder.'/rest/v1/measure-families/area';
     ...
     * @throws APIException Thrown if API call fails
     */
    public function getMeasureFamilies2XOnly()
    {
        ...
        //prepare query string for API call
        $_queryBuilder = $_queryBuilder.'/rest/v1/measure-families';
